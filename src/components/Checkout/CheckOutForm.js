...
const CardField = ({ onChange }) => (
  <div className="FormRow" style={{ height: "50px" }}>
    <CardElement
      style={{ width: "100%" }}
...
const CheckoutForm = (props) => {
  ...
  const { token, clearCart } = React.useContext(UserContext)
  ...
  return paymentMethod ? (
    <div className="Result">
      ...
      <div className="ResultMessage">
        <h1>You're order has been placed, go to profile check for orders</h1>
        Your'e order is complete with order id
      </div>
    ...
    <div className="AppWrapper">
      <Elements stripe={stripePromise} options={ELEMENTS_OPTIONS}>
        {token ? (
          ...
          <>
            <h1>create an acoount or Login</h1>
